...
const errMessage = 'ENV Verification Error:: Cannot find certain required environmental variables. Please review the env requirements file in .env.example for more info';
const warnMessage = 'ENV Warning: Cannot find Certain optional environmental variables :: Please review the env requirements file in .env.example for more info';
